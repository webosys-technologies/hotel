							...
							<tbody>
								...
								if(isset($hoteldata) && count($hoteldata)>0):
									foreach ($hoteldata as $key => $value):
										?>
									<tr class="clickable-row" data-href="<?php echo base_url('htl/Rooms/roomlist')."/".custom_encode($value->hotel_id); ?>">
										...
										<td>
											<a href="<?php echo base_url('htl/Rooms/roomlist')."/".custom_encode($value->hotel_id); ?>" onclick="" class="btn btn-info btn-xs" title="Edit"><i class="fa fa-edit"></i></a>
