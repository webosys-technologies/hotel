...
<body class="hold-transition login-page">
	<div class="login-box">
		<div class="login-logo">
			<a href="<?php echo base_url('admin'); ?>"><img src="<?php echo base_url('assets/images/logo.png'); ?>" alt="<?php echo SITE_NAME; ?>"></a>
		</div>
		<!-- /.login-logo -->
		<div class="login-box-body" >
			...
			<div id="login-form">
				...
				<form id="login_form"  method="post" action="<?php echo base_url('admin'); ?>">
