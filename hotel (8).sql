...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 08, 2018 at 01:42 AM
...
(63, 124, 70, '44', '2018-03-08 00:36:29', 0),
(64, 125, 200, 'admin', '2018-03-08 00:40:03', 0);
...
INSERT INTO `hotel_details` (`hotel_id`, `hotel_name`, `hotel_pic`, `create_user`, `add_time`, `hotel_details`, `isverified`, `hotel_price`, `availabel_room`, `temple_distance`, `hotel_address`, `left_hotel`) VALUES
(121, 'hotel taj', 'download_(3)__02032018_045357__.jpg', 'admin', '2018-03-02 03:49:16', 'Gomtinagar,lucknow', '0', 1200000, 100, '12km', 'Gomtinagar,lucknow', 100),
(122, 'obra', 'download_(1)__02032018_045238__.jpg', 'admin', '2018-03-02 03:52:38', 'delhi', '0', 20000, 200, '20km', 'delhi', 200),
(123, 'mahraja', 'download_(2)__02032018_045334__.jpg', 'admin', '2018-03-02 03:53:34', 'Delhi', '0', 100000, 100, '10km', 'delhi', 23),
(124, 'Nirula', 'download_(3)__08032018_013629__.jpg', '44', '2018-03-08 00:36:29', 'Lucknow', '0', 100000, 70, '20km', 'lucknow', 70),
(125, 'rojvila', 'download__08032018_014003__.jpg', 'admin', '2018-03-08 00:40:03', 'lucknow', '0', 100000, 200, '10km', 'Lucknow', 200);
...
(114, 124, 1, 2000, 1, '100', 1),
(115, 125, 2, 100, 1, '100', 1);
...
INSERT INTO `orders` (`id`, `orderid`, `customer_name`, `customer_email`, `customer_address`, `customer_mobile`, `city`, `pincode`, `amount_pay`, `created_At`, `transaction_id`, `checkin`, `checkout`, `bed_type`, `no_of_room`, `hotel_id`, `avl_room`, `status`, `total_room`) VALUES
(26, 'yjIOo', 'anshulika verma', 'anshulika.v21@gmail.com', '', '7289059869', 'Delhi', '', 30000, '2018-03-07 23:51:20', 'pay_9kFZjyuJtMGW6N', '2018-03-08', '2018-03-24', 2, 77, 123, 23, 1, 100),
(27, '5aTeO', 'anshulika verma', 'anshulika.v21@gmail.com', '', '7289059869', 'Delhi', '', 30000, '2018-03-07 23:55:16', 'pay_9kFdt8HE16VJW3', '2018-03-08', '2018-03-24', 2, 23, 123, 0, 0, 23);
...
--
ALTER TABLE `available_room`
  MODIFY `room_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;
--
-- AUTO_INCREMENT for table `hotel_details`
--
ALTER TABLE `hotel_details`
  MODIFY `hotel_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=126;
--
-- AUTO_INCREMENT for table `hotel_room`
--
ALTER TABLE `hotel_room`
  MODIFY `hotel_room_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=116;
--
...
--
ALTER TABLE `total_price`
  MODIFY `price_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
--
